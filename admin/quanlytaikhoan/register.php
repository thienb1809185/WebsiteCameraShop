...
<head>
	<title>Đăng Ký</title>
	<meta charset="utf-8">
	<link rel="icon" type="image/png" href="https://png.pngtree.com/png-vector/20190130/ourlarge/pngtree-simple-camera-icon-png-transparent-layer-material-camera-iconslr-camera-png-image_688568.jpg" />
...
<body style="background-image: url(../../assets/photos/anhnen_admin.jpg); background-size: cover; background-repeat: no-repeat;">
	<div class="container" style="width: 1020px;">
		<div class="panel panel-primary" style="width: 480px; margin: 0px auto; margin-top: 50px; background-color: white; padding: 10px; border-radius: 5px; box-shadow: 2px 2px gray;">
			...
			<div class="panel-body">
				<form method="post" onsubmit="return validateForm();">
					...
					<button class="btn btn-success"  style="display: block; margin: auto;" >Đăng Ký</button>
				</form>
			</div>
		</div>
	</div>
